...
bestFor: ‘Customers seeking predictable returns with money they won't need immediately’,
...
answer: ‘A savings account is a deposit account held at a bank that pays interest. It provides a safe place to store money you don't plan to spend immediately while earning interest on your balance.’
},
{
...
answer: ‘To open a savings account online, you'll need: a valid government-issued ID, Social Security number, contact information, and funding source for your initial deposit.’
},
{
...
{
question: ‘What's the difference between a savings account and a CD?’,
          ...
          {activeTab === 'cds' && (
            <div className="mt-12">
              ...
              <p className="text-sm text-gray-600 mt-6">
                *APY = Annual Percentage Yield. Rates are effective as of today and subject to change. Early withdrawal penalties may apply.
              </p>
            </div>
          )}
        </div>
